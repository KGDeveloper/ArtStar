...
- (void)setTableView{
    ...
    [_listView registerClass:[HeadLineImageNewsTableViewCell class] forCellReuseIdentifier:@"HeadLineImageNewsTableViewCell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    if (indexPath.row%2==0) {
        if (indexPath.row%3==0) {
            ...
            cell.newsImage = @"http://tougao.duowan.com/pic/2013/10/143/1381729007458.jpg";
            [cell.myImage sd_setImageWithURL:[NSURL URLWithString:@"http://tougao.duowan.com/pic/2013/10/143/1381729007458.jpg"] completed:^(UIImage * _Nullable image, NSError * _Nullable error, SDImageCacheType cacheType, NSURL * _Nullable imageURL) {
