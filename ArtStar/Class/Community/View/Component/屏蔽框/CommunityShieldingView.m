...
- (void)setShieldingOrigin:(CGFloat)shieldingOrigin{
    _shieldingOrigin = shieldingOrigin;
    _whiteView.frame = CGRectMake(ViewX(_whiteView), shieldingOrigin, ViewWidth(_whiteView), ViewHeight(_whiteView));
}
