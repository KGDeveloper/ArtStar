...
@interface CommunityDesigVC ()<MusicInstitutionsViewDelegate,UITextFieldDelegate>
...
@implementation CommunityDesigVC
...
- (MusicInstitutionsView *)institutionsView{
    ...
    if (!_institutionsView) {
        ...
        _institutionsView.chooseStyle = @"设计";
