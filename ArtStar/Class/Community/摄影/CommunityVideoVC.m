...
@interface CommunityVideoVC ()<MusicInstitutionsViewDelegate,UITextFieldDelegate>
...
- (MusicInstitutionsView *)institutionsView{
    ...
    if (!_institutionsView) {
        ...
        _institutionsView.chooseStyle = @"摄影";
