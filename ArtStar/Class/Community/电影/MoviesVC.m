...
@interface MoviesVC ()<MusicInstitutionsViewDelegate,UITextFieldDelegate>
...
- (MusicInstitutionsView *)institutionsView{
    ...
    if (!_institutionsView) {
        ...
        _institutionsView.chooseStyle = @"电影";
