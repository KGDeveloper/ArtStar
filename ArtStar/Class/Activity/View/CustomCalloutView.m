...
- (void)initSubViews{
    ...
    self.portraitView.image = Image(@"20积分");
...
- (void)drawRect:(CGRect)rect {
    ...
    self.layer.shadowColor = Color_333333.CGColor;
