...
@interface MineReleaseArticleView ()<UITableViewDelegate,UITableViewDataSource,DZNEmptyDataSetSource,DZNEmptyDataSetDelegate,MineReleaseArticleTableViewCellDelegate>
...
// MARK: --MineReleaseArticleTableViewCellDelegate--
...
- (void)createData{
    ...
    dispatch_sync(alentQueue, ^{
        [KGRequestNetWorking postWothUrl:seachIssueRecord parameters:@{@"tokenCode":[KGUserInfo shareInterace].userTokenCode,@"issueType":@"3",@"irQuery":@{@"page":@(weakSelf.page),@"rows":@"15"}} succ:^(id result) {
