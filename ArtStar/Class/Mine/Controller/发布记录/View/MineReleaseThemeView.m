...
@interface MineReleaseThemeView ()<UITableViewDelegate,UITableViewDataSource,DZNEmptyDataSetSource,DZNEmptyDataSetDelegate,MineReleaseThemeTableViewCellDelegate>
...
// MARK: --MineReleaseThemeTableViewCellDelegate--
...
- (void)createData{
    ...
    dispatch_sync(alentQueue, ^{
        [KGRequestNetWorking postWothUrl:seachIssueRecord parameters:@{@"tokenCode":[KGUserInfo shareInterace].userTokenCode,@"issueType":@"1",@"irQuery":@{@"page":@(weakSelf.page),@"rows":@"15"}} succ:^(id result) {
