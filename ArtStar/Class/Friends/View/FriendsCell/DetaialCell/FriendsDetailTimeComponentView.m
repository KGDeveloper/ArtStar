...
- (void)setTimeStr:(NSString *)timeStr{
    ...
    _timeLab.sd_layout.widthIs([TransformChineseToPinying stringWidthFromString:timeStr font:FZFont(12) width:ViewX(self)]);
}

- (void)setLocationStr:(NSString *)locationStr{
    _locationStr = locationStr;
    _locationLab.text = locationStr;
    _locationLab.sd_layout.widthIs([TransformChineseToPinying stringWidthFromString:locationStr font:FZFont(12) width:ViewX(self)]);
}
