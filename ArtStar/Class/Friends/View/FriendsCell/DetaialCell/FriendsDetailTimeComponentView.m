...
- (void)setUI{
    ...
    _timeLab.sd_layout.leftSpaceToView(self, 0).topSpaceToView(self, 20).widthIs(100).heightIs(20);
    
    _locationLab.textColor = Color_999999;
    _locationLab.text = @"北京";
    _locationLab.font = FZFont(12);
    _locationLab.sd_layout.leftSpaceToView(_timeLab, 15).topSpaceToView(self, 20).widthIs(100).heightIs(20);
